...
def resolve_ambiguity(question, client):
    """
    Guardrail 1 — check if question is clear enough before any tool runs.
...
Flag as unclear ONLY if time period is ambiguous (e.g. "recently", "lately") or metric is ambiguous (e.g. "performance" with no context).
Do NOT flag clear questions."""},
